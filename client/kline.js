...
class Kline {
  constructor(divid) {
    ...
    this.chartProperties = {
      width: window.innerWidth,//innerWidth.width,
      height: window.innerHeight - 80,//innerWidth.height,
      timeScale: {
        timeVisible: true,
        secondsVisible: true,
      }, layout: {
      ...
      grid: {
        vertLines: { color: '#252424ff' },
        horzLines: { color: '#252424ff' },
      },
    };
  ...
  renderAll() {
    ...
    this.candleseries = this.chart.addSeries(LightweightCharts.CandlestickSeries, this.chartProperties);
    ...
    this.volumeSeries = this.chart.addSeries(LightweightCharts.HistogramSeries, { priceScaleId: "" })
